...
console.log(person['age']);
console.log(person.evaluations);    // waarde bij loggen is [ 7, 10, 9 ]
...
let total1 = selectedColors.push('yellow');
console.log(selectedColors);
let total2 = selectedColors.push(5);
console.log(selectedColors);
let total3 = selectedColors.push({ greeting: "Hi ik ben een object" });
console.log(selectedColors);
console.log(selectedColors[selectedColors.length - 1]);
